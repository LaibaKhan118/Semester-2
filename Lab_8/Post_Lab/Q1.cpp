#include <iostream>
using namespace std;
/*Side Note: I didn't under the purpose of making deposit functions in the derived classes instead of the base class so I have put them in the base class.*/
class BankAccount
{
protected:
    int accountNumber;
...
public:
    ...
    {
        cout << "No annual interest yet!" << endl;
    }
